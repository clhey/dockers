...
/usr/bin/transmission-daemon --foreground --config-dir /config --log-info --username ${USERNAME} --peerport 51413 --password ${PASSWORD} --auth --watch-dir /watch --download-dir /downloads --incomplete-dir /incomplete
